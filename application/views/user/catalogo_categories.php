                ...
                <div class="mt-12 grid place-items-center">
                    <div class="flex pagination">
                        ...
                        <?php if ($atual > 1) {  ?>
                            ...
                            <a href="<?= base_url() ?>catalogo/c/<?= $category['category_slug'] ?><?php if (strlen($this->input->get('precificacao')) > 0) {
                        ...
                        <?php } ?>
                        <?php if ($atual > 1) {  ?>
                            <a href="<?= base_url() ?>catalogo/c/<?= $category['category_slug'] ?>?p=<?= $anterior ?><?php if (strlen($this->input->get('precificacao')) > 0) {
                                                                                                                            echo "&precificacao=" . $this->input->get('precificacao');
                                                                                                                        } else {
                                                                                                                        } ?>">
                        ...
                        <a href="<?= base_url() ?>catalogo/c/<?= $category['category_slug'] ?>?p=<?= $atual ?><?php if (strlen($this->input->get('precificacao')) > 0) {
                                                                                                                    echo "&precificacao=" . $this->input->get('precificacao');
                                                                                                                } else {
                                                                                                                } ?> ">
                        ...
                        <?php if ($atual < $total_pages) {  ?>
                            ...
                            <a href="<?= base_url() ?>catalogo/c/<?= $category['category_slug'] ?>?p=<?= $proxima ?><?php if (strlen($this->input->get('precificacao')) > 0) {
                                                                                                                        echo "&precificacao=" . $this->input->get('precificacao');
                                                                                                                    } else {
                                                                                                                    } ?>">
                        ...
                        <?php if ($atual != $total_pages) {  ?>
                            ...
                            <a href="<?= base_url() ?>catalogo/c/<?= $category['category_slug'] ?>?p=<?= $total_pages ?><?php if (strlen($this->input->get('precificacao')) > 0) {
                                                                                                                            echo "&precificacao=" . $this->input->get('precificacao');
                                                                                                                        } else {
                                                                                                                        } ?> ">
