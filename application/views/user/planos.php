                    ...
                    <div class="home-plano-div">
                        <div>
                            ...
                            <div class="grid place-items-center">
                                <ul class="mt-3 mb-3">
                                    <li><i style="font-size:15px" class="text-greenDefault fa fa-plus"></i><small> Items na biblioteca - <?php if ($p->plan_limit_library == "-1") { echo "<span class='text-greenDefault font-semibold'>ILIMITADO</span>";} else {echo "<span class='text-greenDefault font-semibold'>".$p->plan_limit_library."</span>";} ?> </small></li>
                                    <li><i style="font-size:15px" class="text-greenDefault fa fa-plus"></i><small> Leituras por mês - <?php if ($p->plan_limit_quantity == "-1") { echo "<span class='text-greenDefault font-semibold'>ILIMITADO</span>";} else {echo "<span class='text-greenDefault font-semibold'>".$p->plan_limit_quantity."</span>";} ?></small></small></li>
                                    <li><i style="font-size:15px" class="text-greenDefault fa fa-plus"></i><small> Audiobooks Gratuitos - <?php if ($p->plan_limit_free == "1") { echo "<i  class='fa fa-check text-greenDefault'></i>";} else {echo "<i style='color:red' class='fa fa-close'></i>";} ?></small></li>
                                    <li><i style="font-size:15px" class="text-greenDefault fa fa-plus"></i><small> Audiobooks Pagos - <?php if ($p->plan_limit_premium == "1") { echo "<i  class='fa fa-check text-greenDefault'></i>";} else {echo "<i style='color:red' class='fa fa-close'></i>";} ?></small></li>
