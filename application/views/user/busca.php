        ...
        <div class="mt-12 grid place-items-center">
            <div class="flex pagination">
                ...
                <?php if ($atual > 1) {  ?>
                    ...
                    <a href="<?= base_url() ?>busca/?i=<?php if (strlen($this->input->get('ebook_precificacao')) > 0) { echo "&ebook_precificacao=" . $this->input->get('ebook_precificacao');} ?><?php if (strlen($this->input->get('ebook_title')) > 0) { echo "&ebook_title=" . $this->input->get('ebook_title');} ?><?php if (strlen($this->input->get('ebook_category')) > 0) { echo "&ebook_category=" . $this->input->get('ebook_category');} ?> ">
                        <div class="pagination-item">INÍCIO</div>
                    </a>
                <?php } ?>
                <?php if ($atual > 1) {  ?>
                    <a href="<?= base_url() ?>busca/?p=<?= $anterior ?><?php if (strlen($this->input->get('ebook_precificacao')) > 0) { echo "&ebook_precificacao=" . $this->input->get('ebook_precificacao');} ?><?php if (strlen($this->input->get('ebook_title')) > 0) { echo "&ebook_title=" . $this->input->get('ebook_title');} ?><?php if (strlen($this->input->get('ebook_category')) > 0) { echo "&ebook_category=" . $this->input->get('ebook_category');} ?>" >
                ...
                <a href="<?= base_url() ?>busca/?p=<?= $atual ?><?php if (strlen($this->input->get('ebook_precificacao')) > 0) { echo "&ebook_precificacao=" . $this->input->get('ebook_precificacao');} ?><?php if (strlen($this->input->get('ebook_title')) > 0) { echo "&ebook_title=" . $this->input->get('ebook_title');} ?><?php if (strlen($this->input->get('ebook_category')) > 0) { echo "&ebook_category=" . $this->input->get('ebook_category');} ?>">
                    <div class="pagination-item pagination-item-active"><?= $atual ?></div>
                </a>

                <?php if ($atual < $total_pages) {  ?>

                    <a href="<?= base_url() ?>busca/?p=<?= $proxima ?><?php if (strlen($this->input->get('ebook_precificacao')) > 0) { echo "&ebook_precificacao=" . $this->input->get('ebook_precificacao');} ?><?php if (strlen($this->input->get('ebook_title')) > 0) { echo "&ebook_title=" . $this->input->get('ebook_title');} ?><?php if (strlen($this->input->get('ebook_category')) > 0) { echo "&ebook_category=" . $this->input->get('ebook_category');} ?>" >
                ...
                <?php if ($atual != $total_pages) {  ?>
                    ...
                    <a href="<?= base_url() ?>busca/?p=<?= $total_pages ?><?php if (strlen($this->input->get('ebook_precificacao')) > 0) { echo "&ebook_precificacao=" . $this->input->get('ebook_precificacao');} ?><?php if (strlen($this->input->get('ebook_title')) > 0) { echo "&ebook_title=" . $this->input->get('ebook_title');} ?><?php if (strlen($this->input->get('ebook_category')) > 0) { echo "&ebook_category=" . $this->input->get('ebook_category');} ?>">
