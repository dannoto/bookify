                    ...
                    <div class="grid place-items-center">
                        <div class=" ">
                            <form action="" method="POST" class="xl:pt-14 pt-8 xl:m-0 m-8" id="form-register">
                                ...
                                <input style="border:1px solid #DFDFDF" maxlength="200" type="email" name="user_email" class="p-2" value="<?php if ($this->input->get('user_email')) { echo $this->input->get('user_email');}?>" required placeholder="SEU E-MAIL">
                                ...
                                <input style="border:1px solid #DFDFDF" maxlength="200" type="hidden" name="user_origin" class="p-2" value="<?php if (isset($_COOKIE['ref'])) { echo $_COOKIE['ref'];}?>" required >
