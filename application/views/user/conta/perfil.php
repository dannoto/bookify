                    ...
                    <div class="xl:col-span-2 catalogo-right grid place-items-center xl:block hidden">
                        ...
                        <ul class="grid xl:col-span-1 pt-5 xl:pt-12 xl:grid submenu_mobile">
                            <a href="<?= base_url() ?>conta/perfil">
                                <li style="height:50px;font-size:20px;padding-top:7px;font-weight:normal;border:1px solid #ddd;border-radius:0px;paddinf:12px;padding-left:18px" class="submenu_mobile_item xl:ml-12 <?php if ($this->input->get('classificacao') == base_url() . "conta/perfil" || !$this->input->get('classificacao')) {
                            ...
                            <a href="<?= base_url() ?>conta/seguranca">
                                <li style="height:50px;font-size:20px;padding-top:7px;font-weight:normal;border:1px solid #ddd;border-radius:0px;paddinf:12px;padding-left:18px" class="submenu_mobile_item xl:ml-12 <?php if ($this->input->get('classificacao') ==  base_url() . "conta/seguranca") {
                                                                                                                                                                                                                            echo " catalogo-active";
                                                                                                                                                                                                                        } ?>">
                                    SEGURANÇA
                                </li>
                            ...
                            <a href="<?= base_url() ?>conta/assinatura">
                                <li style="height:50px;font-size:20px;padding-top:7px;font-weight:normal;border:1px solid #ddd;border-radius:0px;paddinf:12px;padding-left:18px" class="submenu_mobile_item xl:ml-12 <?php if ($this->input->get('classificacao') ==  base_url() . "conta/assinatura") {
                                                                                                                                                                                                                            echo " catalogo-active";
                                                                                                                                                                                                                        } ?>">
                                    ASSINATURA
                                </li>
