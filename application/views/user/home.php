                    ...
                    <?php foreach ($this->raffles_model->getRafflesFeatured()  as $t) { ?>
                        <a href="<?=base_url() ?>sorteio/<?=$t->id?>">
                            <div class="xl:col-span-1 col-span-1 xl:m-0 m-3 " style="position:relative;z-index: 1;">
                                ...
                                <div style="background-color:black;opacity:0.3;height:350px;left:0;right:0;top:0;position:absolute;width:100%;z-index: 2;">
                                ...
                                <div  class="ml-5 mr-5 p-3 bg-darkLight mb-5" style="background-image:url(<?=base_url() ?>assets/img/raffles/<?=$t->raffles_image?>);background-repeat:none; height:350px;object-fit:cover;background-position:center">
                                    <div class="xl:w-1/3 xl:ml-12" style="z-index: 3;">
     ...
     <section class="xl:mr-20 mb-5 xl:ml-20 mr-8 ml-8">
        ...
        <div class="grid xl:grid-cols-4 grid-cols-1 mb-3 mt-3" >
            <div class="col-span-1 text-white m-1 xl:mb-0 mb-12" >
                    ...
                    <p class="line-clamp-1 mt-1 mb-1 font-semibold">Vale Transporte4 Vale Transporte4 Vale</p>    
            ...
            <div class="owl-carousel col-span-3">
                <div class="text-white">
                    ...
                    <p class="line-clamp-1 mt-1 mb-1 font-semibold">Vale Transporte4 Vale Transporte4 Vale</p>    
                    <p class="justify" ><small>Vale Transporte4 Vale Transporte4 Vale Vale Transporte4 Vale Transporte4 Vale Vale Transporte4 Vale Transporte4 Vale</small></p>
                    <small>Amanda Freitas </small>
                </div>
                <div class="text-white">
                    <div>
                        <span class="fa fa-star checked"></span>
